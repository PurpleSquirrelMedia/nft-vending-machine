...
// export const HOME_HEADLINE = "Home Headline";
export const HOME_SUBHEAD = "100% of proceeds go to Metaplex's Help Ukraine Campaign";
export const HOME_BODY = "Learn more here: donate.metaplex.com";
